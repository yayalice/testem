...
App.prototype = {
    ...
    , setupReporter: function(){
        try{
            ...
            this.reporter = new require('mocha/lib/reporters/' + reporterName)
        }catch(e){
            log.error('Reporter ' + reporterName + ' doesn\'t exist, falling back to tap.')
            this.reporter = new require('mocha/lib/reporters/tap')
        }
